...
public class BatteryDetailsAdapter extends SuperAdapter<BatteryDetailsBean> {

    public BatteryDetailsAdapter(Context context, List<BatteryDetailsBean> mDatas, int layoutId) {
