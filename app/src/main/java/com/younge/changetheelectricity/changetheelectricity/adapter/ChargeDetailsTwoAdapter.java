...
public class ChargeDetailsTwoAdapter extends SuperAdapter<BatteryDetailsBean> {

    public ChargeDetailsTwoAdapter(Context context, List<BatteryDetailsBean> mDatas, int layoutId) {
