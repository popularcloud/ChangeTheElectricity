...
public class ConfirmOrderAdapter extends SuperAdapter<BatteryDetailsBean> {

    public ConfirmOrderAdapter(Context context, List<BatteryDetailsBean> mDatas, int layoutId) {
